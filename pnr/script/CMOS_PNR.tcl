...
create_lib -technology "/home/hotwater/Voltage_Stacking/PipelinedCore/Design/SIGNOFF/LIBERATE/run_char/pnr_test/inputs/tsmcn65_CMOS.tf" -ref_libs $LIB_NAME LANE_CMOS
derive_design_level_via_regions


set VERILOG_NETLIST [list   "/home/hotwater/Voltage_Stacking/PipelinedCore/Design/SIGNOFF/LIBERATE/run_char/pnr_test/inputs/LANE_CMOS_V2.v"
                    ]
#read_verilog_outline -library LANE_CMOS "/home/hotwater/Voltage_Stacking/PipelinedCore/Design/SIGNOFF/LIBERATE/run_char/pnr_test/inputs/ALU_BARE_v3.v"
#read_verilog_outline -library LANE_CMOS "/home/hotwater/Voltage_Stacking/PipelinedCore/Design/SIGNOFF/LIBERATE/run_char/pnr_test/inputs/SHIFTER.v"
read_verilog_outline -library LANE_CMOS $VERILOG_NETLIST
link_block
#set_working_design_stack DUPASABL:ALU.outline
set_working_design_stack LANE_CMOS:lane.outline
expand_outline
set top_module lane
...
create_pg_mesh_pattern mesh_pattern -layers {{{vertical_layer : M9} {width : 3} {spacing : interleaving} {pitch : 40} {trim : true} {track_alignment : auto}} {{horizontal_layer : M8} {width : 1} {offset : 1.1} {spacing : interleaving} {pitch : 14.4} {trim : true} {track_alignment : auto}}} \
                                    -via_rule { {intersection: adjacent} {via_master : default} }
